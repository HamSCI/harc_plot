...
#run_name    = 'Europe'
run_name    = 'World'
data_dir    = os.path.join('data/histograms_solarcycle_3hr',run_name)
plot_dir    = os.path.join('output/galleries/histograms_solarcycle_3hr',run_name)
params      = ['spot_density']
xkeys       = ['ut_hrs','slt_mid']
#xkeys       = ['ut_hrs']
#sTime       = datetime.datetime(2018,1,1)
sTime       = datetime.datetime(2009,1,1)
eTime       = datetime.datetime(2014,1,1)
region      = run_name
rgc_lim     = (0, 10000)
